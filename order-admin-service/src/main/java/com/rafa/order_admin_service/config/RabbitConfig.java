...
//    }
    @Bean
    public Queue syncAdminUpdateOrderQueue(){
        return new Queue("adminUpdateOrderQueue",true,false,false);
    }
//    @Bean
//    public Queue userUpdateOrderQueue(){
...
//    }
    @Bean
    public Binding adminUpdateOrderBinding(){
        return BindingBuilder.bind(syncAdminUpdateOrderQueue()).to(orderExchange()).with("adminUpdateOrderRoute");
    }
