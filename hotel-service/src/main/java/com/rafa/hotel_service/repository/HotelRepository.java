...
public interface HotelRepository extends JpaRepository<Hotel, Long> {
    ...
    public Set<Integer> findAllCityAddress();
    ...
    @Query("SELECT h FROM Hotel h WHERE :userId MEMBER OF h.likedByUsersIds")
    public List<Hotel> findFavoriteHotelsByUserId(@Param("userId") Long userId);
